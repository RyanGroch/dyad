          ...
          },
          {
            onChunk: ({
              ...
              if (updatedMessages) {
                ...
                //
                // Fix: prevent response truncation while streaming. Without
                // this clear, a stale dropped-bytes counter caused subsequent
                // patches to splice at the wrong local offset, chopping the
                // visible response.
                //
                ...
                if (streamingMessageId !== undefined && streamingMsg) {
                  // Replace each map with a single entry for the streaming
